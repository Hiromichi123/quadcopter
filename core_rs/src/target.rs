...
impl Target {
    ...
    // 获取成员
    pub fn get_x(&self) -> f32 { self.pose_stamped.pose.position.x }
    pub fn get_y(&self) -> f32 { self.pose_stamped.pose.position.y }
    pub fn get_z(&self) -> f32 { self.pose_stamped.pose.position.z }
    ...
    // 设置PoseStamped成员
    pub fn set_x(&mut self, x: f32) { self.pose_stamped.pose.position.x = x; }
    pub fn set_y(&mut self, y: f32) { self.pose_stamped.pose.position.y = y; }
    pub fn set_z(&mut self, z: f32) { self.pose_stamped.pose.position.z = z; }
    pub fn set_yaw(&mut self, yaw: f32) { self.pose_stamped.pose.orientation.z = (yaw / 2.0).sin(); self.pose_stamped.pose.orientation.w = (yaw / 2.0).cos(); }
    // 设置时间戳
